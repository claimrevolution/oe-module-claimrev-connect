...
use OpenEMR\Modules\ClaimRevConnector\ReconciliationMockService;
...
if (ModuleInput::isPostRequest() && ModuleInput::postExists('SubmitButton')) {
    $searched = true;
    $result = $testMode
        ? ReconciliationMockService::reconcile($searchFilters)
        : ReconciliationService::reconcile($searchFilters);
