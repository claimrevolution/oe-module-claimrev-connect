...
Module version: see `Bootstrap::MODULE_VERSION`. Current: **2.1.3**.
...
| `oe_claimrev_enable_test_mode`                   | Switches every test-mode-capable page (Payment Advice, ERA, Reconciliation, Eligibility) to mock data generated from local billing rows. ERA Download returns a 0-byte placeholder; Reconciliation row actions short-circuit to fake-success. |
